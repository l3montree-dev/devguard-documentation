---
title: API Endpoint Template for DevGuard
description: >-
  API Endpoint Template: Template for documenting DevGuard API endpoint
  references with request and response examples. Learn more about API endpoint.
...
tags:
  ...
  - - resource-type
seo:
  keyword_primary: API endpoint template
  robots: 'noindex,nofollow'
  og:
    title: API Endpoint Template for DevGuard
    description: >-
      API Endpoint Template: Template for documenting DevGuard API endpoint
      references with request and response examples. Learn more about API
      endpoint.
    image: /og-image.png
    type: article
    schema:
