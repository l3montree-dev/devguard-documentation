---
title: Manage Assets via API
description: How to use the DevGuard REST API to create and manage projects, repositories, and assets programmatically with authentication tokens.
seo:
  keyword_primary: "DevGuard API manage assets"
  keywords_secondary:
    - "DevGuard REST API"
    - "programmatic project management"
    - "API asset creation DevGuard"
  og:
    title: "Manage Assets via API | DevGuard"
    description: "Use the DevGuard REST API to create and manage projects and repositories programmatically."
    type: "article"
---
