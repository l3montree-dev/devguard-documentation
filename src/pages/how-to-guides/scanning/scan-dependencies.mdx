...
description: "Analyze project dependencies for vulnerabilities using SCA with DevGuard scanner — generating SBOMs and identifying affected packages for remediation."
seo:
