---
title: Scan Docker OCI Images CVE
description: >-
  Scan Docker OCI images CVE vulnerabilities and generate SBOMs using DevGuard
  scanner — integrating container security into your CI/CD pipeline.
seo:
  robots: 'index,follow'
  og:
    title: Scan Docker OCI Images CVE
    description: >-
      Scan Docker OCI images CVE vulnerabilities and generate SBOMs using
      DevGuard scanner — integrating container security into your CI/CD
      pipeline.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: scan Docker OCI images CVE
lang: en-US
ignoreChecks:
