---
title: "Scan Docker and OCI Images for CVEs"
description: "Scan Docker OCI images CVE vulnerabilities and generate SBOMs using DevGuard scanner — integrating container security into your CI/CD pipeline."
seo:
  keyword_primary: "scan Docker OCI images CVE"
  keywords_secondary:
    - "container image vulnerability scan"
    - "Docker SBOM generation"
    - "OCI image security scan"
  og:
    type: "article"
lang: "en-US"
og:
  title: "Scan Docker OCI Images CVE with DevGuard"
  description: "Scan Docker OCI images CVE vulnerabilities and generate SBOMs using DevGuard scanner — integrating container security into your CI/CD pipeline."
  image: "/og-image.png"
  type: "article"
  schema:
