...
description: "Learn how the DevGuard CI scanner handles refs and artifact names, why you should not add @branch or @version to names, and how every branch/tag gets scanned."
seo:
  robots: index,follow
  og:
    image: /og-image.png
...
The `devguard-scanner` tool generates an SBOM (or SARIF report) for your project, signs it, and uploads it to DevGuard, where it is [matched](/explanations/vulnerability-management/vulnerability-matching) against the vulnerability database. Every scan is filed under three coordinates: **which repository**, **which branch or tag**, and **which artifact**.
...
- [Scan Dependencies](/how-to-guides/scanning/scan-your-project#scan-dependencies) — full SCA scanner reference and flags
- [Scan OCI Images](/how-to-guides/scanning/scan-your-project#scan-docker-images) — scan container images per artifact
...
- [Multi-Level VEXing for Releases](/how-to-guides/vex/multi-level-vexing) — bundling the artifacts of a release into one asset
