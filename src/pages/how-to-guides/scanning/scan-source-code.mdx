...
description: Run SAST, IaC, and secret detection to scan source code security issues
  — detect first-party vulnerabilities and misconfigurations using DevGuard scanner.
seo:
  robots: index,follow
  og:
    image: /og-image.png
