export default {
    'scan-docker-images': { title: 'Scan OCI Images' },
    'scan-source-code': { title: 'Scan Source Code' },
    'scan-dependencies': { title: 'Scan Dependencies' },
    'branches-tags-and-artifacts': { title: 'Branches, Tags & Artifacts' },
