...
description: Integrate DevGuard security scanning into your GitLab CI/CD pipeline using GitLab CI components for SCA, SAST, container scanning, and more.
seo:
  keyword_primary: "DevGuard GitLab CI scanning"
  keywords_secondary:
    - "GitLab CI security scan"
    - "DevGuard GitLab pipeline"
    - "GitLab CI component DevGuard"
  og:
    title: "Scan with GitLab CI | DevGuard"
    description: "Integrate DevGuard security scanning into GitLab CI pipelines using reusable components."
    type: "article"
---
