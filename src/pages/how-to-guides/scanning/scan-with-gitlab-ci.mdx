---
title: DevGuard Scan with GitLab CI
...
seo:
  ...
  schema:
    type: TechArticle
  keyword_primary: scan with gitlab ci
lang: en-US
ignoreChecks: null
---
...
- [Upload an SBOM](/how-to-guides/scanning/scan-your-project#upload-an-existing-sbom) — upload pre-generated SBOMs
