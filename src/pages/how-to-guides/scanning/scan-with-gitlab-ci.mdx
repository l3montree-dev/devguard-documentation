---
title: DevGuard GitLab CI Scanning
description: >-
  Integrate DevGuard GitLab CI scanning into your pipeline using GitLab CI
  components for SCA, SAST, container scanning, and secret detection workflows.
seo:
  robots: 'index,follow'
  og:
    title: DevGuard GitLab CI Scanning
    description: >-
      Integrate DevGuard GitLab CI scanning into your pipeline using GitLab CI
      components for SCA, SAST, container scanning, and secret detection
      workflows.
    image: /og-image.png
    type: article
    schema:
