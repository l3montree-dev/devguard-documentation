---
title: Upload VEX Document to DevGuard
description: "Upload VEX document DevGuard to mark vulnerabilities as not affected, in triage, or remediated for compliance reporting and auditable security decisions."
seo:
  robots: index,follow
  og:
    image: /og-image.png
...
<Callout type="info">
  Replace `vex.json` with the path to your VEX document. The scanner accepts CycloneDX VEX (JSON or XML). To import CSAF or OpenVEX, add the document as an upstream source URL instead — see [Import VEX from Files & Suppliers](/how-to-guides/vex/import-vex).
</Callout>
