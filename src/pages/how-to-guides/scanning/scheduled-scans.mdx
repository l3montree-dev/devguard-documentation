...
<Callout type="info">
  **Fully Automated**: The entire asset scanning pipeline runs automatically. You don't need to trigger scans manually or configure cron jobs—DevGuard handles everything for you.
</Callout>
