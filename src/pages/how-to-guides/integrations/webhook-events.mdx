...
description: Complete reference of DevGuard webhook events — event types, payload
  formats, and how to configure subscriptions for integrations and automations.
seo:
  robots: index,follow
  og:
    image: /og-image.png
