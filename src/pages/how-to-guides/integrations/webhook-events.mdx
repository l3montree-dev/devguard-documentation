...
description: Complete reference of DevGuard webhook events — event types, payload formats, and how to configure event subscriptions for your integrations.
seo:
  keyword_primary: "DevGuard webhook events"
  keywords_secondary:
    - "webhook event payload"
    - "DevGuard event subscription"
    - "security event webhook"
  og:
    title: "Webhook Events | DevGuard"
    description: "Reference of DevGuard webhook event types, payload formats, and subscription configuration."
    type: "article"
---
