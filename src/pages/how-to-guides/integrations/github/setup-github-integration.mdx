...
description: "Step-by-step guide to connect DevGuard with GitHub — install the GitHub App, sync repositories, and enable automatic security scanning for your GitHub."
seo:
