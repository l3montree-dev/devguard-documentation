...
description: "Step-by-step guide to setup DevGuard GitHub integration — install the GitHub App, sync repositories, and enable automatic security scanning."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: set up github integration
lang: en-US
ignoreChecks: null
---
...
You can find more information about the DevGuard Personal Access Token [here](/getting-started/use-devguard-api).
...
- [DevGuard Integrations How-To Guides](/how-to-guides/integrations)
