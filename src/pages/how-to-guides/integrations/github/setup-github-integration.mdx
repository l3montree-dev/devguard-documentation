...
description: Step-by-step guide to connect DevGuard with GitHub — install the GitHub App, sync repositories, and enable automatic security scanning for your GitHub projects.
seo:
  keyword_primary: "setup DevGuard GitHub integration"
  keywords_secondary:
    - "GitHub App DevGuard install"
    - "GitHub repository sync"
    - "GitHub security scanning setup"
  og:
    title: "Setup GitHub Integration | DevGuard"
    description: "Connect DevGuard to GitHub — install the App, sync repos, and enable automatic security scanning."
    type: "article"
---
...
You can find more information about the pipeline configuration file [here](/reference/github-workflows/full-scan).
