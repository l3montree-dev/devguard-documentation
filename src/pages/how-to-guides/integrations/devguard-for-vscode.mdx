...
After connecting to your DevGuard instance you can run a [software composition analysis (SCA) scan](/how-to-guides/scanning/scan-your-project#scan-dependencies) to generate an SBOM for your project.
