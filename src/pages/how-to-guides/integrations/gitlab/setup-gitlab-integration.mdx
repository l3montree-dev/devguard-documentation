---
title: Setup GitLab Integration
description: Step-by-step guide to connect DevGuard with GitLab — configure OAuth, sync groups and repositories, and enable CI/CD security scanning components.
seo:
  keyword_primary: "setup DevGuard GitLab integration"
  keywords_secondary:
    - "GitLab OAuth DevGuard"
    - "GitLab group sync DevGuard"
    - "GitLab CI security setup"
  og:
    title: "Setup GitLab Integration | DevGuard"
    description: "Connect DevGuard to GitLab — configure OAuth, sync groups, and enable CI/CD security scanning."
    type: "article"
---
...
You can find more information about the pipeline configuration file [here](/reference/gitlab-components/full-scan).
