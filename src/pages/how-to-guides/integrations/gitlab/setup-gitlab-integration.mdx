---
title: Setup DevGuard GitLab Integration
description: >-
  Setup DevGuard GitLab Integration: Step-by-step guide to connect DevGuard with
  GitLab — configure OAuth, sync groups and repositories, and enable CI/CD…
seo:
  robots: 'index,follow'
  og:
    title: Setup DevGuard GitLab Integration
    description: >-
      Setup DevGuard GitLab Integration: Step-by-step guide to connect DevGuard
      with GitLab — configure OAuth, sync groups and repositories, and enable
      CI/CD…
    image: /og-image.png
    type: article
    schema:
