...
description: "Structured process for systematically hardening container images with automated DevGuard scanning, vulnerability triage, and compliance verification steps."
seo:
  robots: index,follow
  og:
    image: /og-image.png
...
- Strive for **hardened build environments** (like defined in SLSA Level 3 - [SLSA Level 3 on GitLab](/explanations/supply-chain-security/slsa-level-3)).
...
Follow the process described in the [Container Hardening CVE Decision Guide](/how-to-guides/container-hardening/cve-decision)
...
[Container Hardening Work Bench Project](https://gitlab.opencode.de/open-code/oci/container-hardening-work-bench).
...
[Container Hardening CVE Decision Guide](/how-to-guides/container-hardening/cve-decision) to handle them.
...
(you can find details why in the [Supplementary SBOMs](/explanations/supplementary-sboms)).
