...
description: "Step-by-step guide for hardening container images using DevGuard scanning and vulnerability management — covering triage, CVE decisions, and compliance."
seo:
  robots: index,follow
  og:
    image: /og-image.png
    type: article
  keyword_primary: container hardening guide
  schema:
    type: TechArticle
lang: en-US
ignoreChecks: null
...
- [BSI IT-Grundschutzbaustein SYS.1.6 Containerisierung](https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Grundschutz/IT-GS-Kompendium_Einzel_PDFs_2022/07_SYS_IT_Systeme/SYS_1_6_Containerisierung_Edition_2022.pdf?__blob=publicationFile&v=3),
   Bundesamt für Sicherheit in der Informationstechnik (BSI), 2022, accessed 04.09.25
...
- [Container Hardening Process Guide](/how-to-guides/container-hardening/process)
- [Infrastructure as Code (IAC)](/explanations/devsecops/iac)
