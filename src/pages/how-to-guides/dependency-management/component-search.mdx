---
title: "Search Software Components in DevGuard"
description: "Find and analyze search software components DevGuard across repositories — searching for specific packages, versions, and understanding their security impact."
seo:
  keyword_primary: "search software components DevGuard"
  keywords_secondary:
    - "find package across repositories"
...
lang: "en-US"
og:
  title: "Search Software Components DevGuard Guide"
  description: "Find and analyze search software components DevGuard across repositories — searching for specific packages, versions, and understanding their security impact."
  image: "/og-image.png"
  type: "article"
  schema:
