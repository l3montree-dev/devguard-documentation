...
<Callout type="info">
  OSI-approved licenses include Apache 2.0, MIT, GPL 3.0, BSD variants, and many others. See [opensource.org/licenses](https://opensource.org/licenses) for the complete list.
</Callout>
...
- [Generate VEX Documents](../compliance/generate-vex-documents.mdx) - Include license decisions in VEX
