---
title: Override License Decisions DevGuard
description: >-
  Override license decisions DevGuard — correct or replace detected component
  licenses to ensure accurate compliance reporting for all dependencies.
seo:
  robots: 'index,follow'
  og:
    title: Override License Decisions DevGuard
    description: >-
      Override license decisions DevGuard — correct or replace detected
      component licenses to ensure accurate compliance reporting for all
      dependencies.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: override license decisions DevGuard
lang: en-US
ignoreChecks:
