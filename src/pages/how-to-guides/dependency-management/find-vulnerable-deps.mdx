...
description: "Find vulnerable dependencies across your projects with DevGuard — filtering packages by CVE severity, viewing affected versions, and fix recommendations."
seo:
  robots: "index,follow"
  og:
    image: "/og-image.png"
...
- [Export & Publish VEX](/how-to-guides/vex/export-vex) - Document vulnerability decisions
