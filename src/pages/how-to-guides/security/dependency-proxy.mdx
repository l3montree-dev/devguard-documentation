...
description: Protect your supply chain with DevGuard's dependency proxy that blocks malicious packages before they reach your systems
seo:
  keyword_primary: "dependency proxy malicious packages"
  keywords_secondary:
    - "supply chain attack prevention"
    - "package registry proxy"
    - "malicious package firewall"
  og:
    title: "Dependency Proxy with Malicious Package Firewall | DevGuard"
    description: "Protect your supply chain with DevGuard's dependency proxy that blocks malicious packages."
    type: "article"
---
