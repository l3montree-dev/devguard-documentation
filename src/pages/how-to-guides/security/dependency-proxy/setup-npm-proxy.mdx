...
description: "Configure npm to route package downloads through the DevGuard dependency proxy for malicious package detection and enforcing security policies."
seo:
  robots: index,follow
  og:
    image: /og-image.png
