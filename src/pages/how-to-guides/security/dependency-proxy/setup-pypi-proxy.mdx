...
description: Configure pip and Python tools to route package downloads through the DevGuard dependency proxy for malicious package protection
seo:
  keyword_primary: "PyPI proxy DevGuard setup"
  keywords_secondary:
    - "pip registry proxy"
    - "Python package proxy"
    - "PyPI malicious package protection"
  og:
    title: "Setup PyPI Proxy | DevGuard"
    description: "Configure pip to route Python package downloads through the DevGuard dependency proxy for malicious package protection."
    type: "article"
---
