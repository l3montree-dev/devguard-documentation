---
title: Create and Manage DevGuard API Tokens
description: >-
  Generate and manage DevGuard API tokens for programmatic access and automation
  — creating, scoping, and revoking tokens for CI/CD pipeline authentication.
seo:
  robots: 'index,follow'
  og:
    title: Create and Manage DevGuard API Tokens
    description: >-
      Generate and manage DevGuard API tokens for programmatic access and
      automation — creating, scoping, and revoking tokens for CI/CD pipeline
      authentication.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: DevGuard API tokens
lang: en-US
ignoreChecks:
