---
title: Upgrade DevGuard
description: How to upgrade your DevGuard instance to a new version — Docker Compose upgrade procedure, Helm chart updates, and migration considerations.
seo:
  keyword_primary: "upgrade DevGuard version"
  keywords_secondary:
    - "DevGuard version upgrade"
    - "Helm chart upgrade"
    - "Docker Compose update DevGuard"
  og:
    title: "Upgrade DevGuard | DevGuard"
    description: "Step-by-step guide to upgrade your DevGuard instance via Docker Compose or Helm chart."
    type: "article"
---
