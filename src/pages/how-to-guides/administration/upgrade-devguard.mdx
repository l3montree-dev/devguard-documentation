...
description: Step-by-step guide to upgrade DevGuard version — Docker Compose upgrade
  procedure, Helm chart updates, and migration considerations for self-hosted instances.
seo:
  robots: index,follow
  og:
    image: /og-image.png
