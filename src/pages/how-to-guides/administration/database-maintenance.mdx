...
description: DevGuard database maintenance guide — automated vulnerability database updates, manual refresh procedures, and troubleshooting database issues.
seo:
  keyword_primary: "DevGuard database maintenance"
  keywords_secondary:
    - "vulnerability database update"
    - "PostgreSQL DevGuard maintenance"
    - "DevGuard database troubleshooting"
  og:
    title: "Database Maintenance | DevGuard"
    description: "Maintain your DevGuard database — automated updates, manual refresh, and troubleshooting."
    type: "article"
---
