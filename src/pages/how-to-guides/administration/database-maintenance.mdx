...
Vulnerability data is fetched from the [vulndb-diff](https://github.com/l3montree-dev/devguard/pkgs/container/devguard%2Fvulndb-diff) OCI registry. Each data package is **cryptographically signed** and verified before import using the bundled `cosign.pub` public key.
