...
description: DevGuard database maintenance — automated vulnerability database updates,
  manual refresh procedures, and troubleshooting database issues for administrators.
seo:
  robots: index,follow
  og:
    image: /og-image.png
