---
title: DevGuard Database Maintenance Guide
description: "DevGuard database maintenance — automated vulnerability database updates, manual refresh procedures, and troubleshooting database issues for administrators."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: database maintenance
lang: en-US
ignoreChecks: null
---
...
The malicious package database powers the [dependency proxy firewall](/how-to-guides/dependency-proxy). It updates alongside the vulnerability database.
