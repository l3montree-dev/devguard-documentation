...
description: "How to deploy DevGuard Docker Compose setup locally or in production — configuration, environment variables, and getting started with docker-compose."
seo:
...
lang: "en-US"
og:
  title: "Deploy DevGuard Docker Compose Setup"
  description: "How to deploy DevGuard Docker Compose setup locally or in production — configuration, environment variables, and getting started with docker-compose."
  image: "/og-image.png"
  type: "article"
  schema:
