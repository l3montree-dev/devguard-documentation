...
description: How to deploy DevGuard locally or in production using Docker Compose — configuration, environment variables, and getting started with docker-compose.
seo:
  keyword_primary: "deploy DevGuard Docker Compose"
  keywords_secondary:
    - "DevGuard self-hosted Docker"
    - "docker-compose security platform"
    - "DevGuard local deployment"
  og:
    title: "Deploy DevGuard with Docker Compose | DevGuard"
    description: "Deploy DevGuard using Docker Compose — configuration, environment setup, and self-hosting guide."
    type: "article"
---
...
> deployments, use the [Helm chart](/how-to-guides/administration/deploy-with-helm).
