...
description: How to customize the DevGuard web interface with custom CSS, JavaScript, and configure legal notices and contact information for your organization.
seo:
  keyword_primary: "customize DevGuard UI"
  keywords_secondary:
    - "DevGuard custom CSS"
    - "white-label security platform"
    - "DevGuard branding configuration"
  og:
    title: "Customize the UI | DevGuard"
    description: "Add custom CSS, JavaScript, and configure branding in your DevGuard instance."
    type: "article"
---
