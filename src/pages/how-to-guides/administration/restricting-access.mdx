---
title: OIDC & Restricting Access
description: Configure OIDC authentication and restrict access to your DevGuard instance — disable public registration, connect identity providers, and manage allowed domains.
seo:
  keyword_primary: "DevGuard OIDC access restriction"
  keywords_secondary:
    - "DevGuard OIDC configuration"
    - "restrict user registration DevGuard"
    - "identity provider SSO DevGuard"
  og:
    title: "OIDC & Restricting Access | DevGuard"
    description: "Configure OIDC and restrict access to your DevGuard instance with identity providers."
    type: "article"
---
