...
DevGuard uses Ory Kratos for identity and authentication management. For advanced configuration options and detailed guides on self-hosted deployments, refer to the [Ory Kratos self-hosted documentation](https://www.ory.sh/docs/kratos/self-hosted).