...
description: >-
  Configure DevGuard OIDC access restriction — disable public registration,
  connect identity providers, and manage allowed users for your installation.
seo:
  robots: 'index,follow'
  og:
    title: DevGuard OIDC Access Restriction Setup
    description: >-
      Configure DevGuard OIDC access restriction — disable public registration,
      connect identity providers, and manage allowed users for your
      installation.
    image: /og-image.png
    type: article
    schema:
