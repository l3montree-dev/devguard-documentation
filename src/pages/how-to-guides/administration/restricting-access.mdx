...
description: "Configure DevGuard OIDC access restriction — disable public registration, connect identity providers, and manage allowed users for your installation."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: oidc & restricting access
lang: en-US
ignoreChecks: null
---
...
DevGuard uses Ory Kratos for identity and authentication management. For advanced configuration options and detailed guides on self-hosted deployments, refer to the [Ory Kratos self-hosted documentation](https://www.ory.com/docs/oss/getting-started).
