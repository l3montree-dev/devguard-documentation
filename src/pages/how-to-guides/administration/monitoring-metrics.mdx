...
description: Monitor your DevGuard instance with Prometheus metrics — available metric endpoints, alerting configuration, and Grafana dashboard setup.
seo:
  ...
  og:
    title: "Monitoring & Metrics | DevGuard"
    description: "Monitor DevGuard with Prometheus metrics, configure alerts, and build Grafana dashboards."
    type: "article"
---
