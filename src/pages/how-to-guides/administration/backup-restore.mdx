...
description: How to back up and restore your DevGuard instance — database dumps, configuration backup, and disaster recovery procedures for self-hosted deployments.
seo:
  keyword_primary: "DevGuard backup restore"
  keywords_secondary:
    - "DevGuard disaster recovery"
    - "PostgreSQL backup DevGuard"
    - "self-hosted backup procedure"
  og:
    title: "Backup & Restore | DevGuard"
    description: "Database backup, configuration backup, and disaster recovery for self-hosted DevGuard."
    type: "article"
---
