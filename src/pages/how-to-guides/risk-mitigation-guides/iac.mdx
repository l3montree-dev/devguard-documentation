...
<Callout type="info" emoji="ℹ️">
  DevGuard performs infrastructure as code (IaC) scanning to identify vulnerabilities in your project's infrastructure configurations (e.g. Dockerfile or Helm-Chart) - [Background Information](../../explanations/devsecops/iac)
</Callout>
