...
<Callout type="info" emoji="ℹ️">
  DevGuard performs static application security testing (SAST) to analyze your code for bad practices. This helps identify potential security issues early in the development process (based on SARIF) - [Background Information](../../explanations/devsecops/sast)
</Callout>
