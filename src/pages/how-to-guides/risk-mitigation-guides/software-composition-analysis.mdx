...
<Callout type="info" emoji="ℹ️">
  DevGuard performs continous sca to identify vulnerabilities in your project's dependencies after your first scan (based on SBOM) - [Background Information](../../explanations/devsecops/software-composition-analysis)
</Callout>
...
<Tabs items={['npm', 'npm audit', 'go', 'python']}>
    <Tabs.Tab>
