...
- [Export & Publish VEX](/how-to-guides/vex/export-vex) - Document vulnerability assessments
- [Understand Compliance Frameworks](/explanations/compliance/iso-27001-mapping) - Learn ISO 27001 requirements
- [CSAF Reports in DevGuard](/how-to-guides/vulnerability-management/csaf-common-security-advisory-framework) - Create compliance-focused security advisories
- [Export & Publish VEX](/how-to-guides/vex/export-vex) - Document vulnerability assessments
