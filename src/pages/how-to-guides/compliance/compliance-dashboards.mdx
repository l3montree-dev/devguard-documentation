...
description: "Monitor control status with the DevGuard compliance dashboard — track policy violations across your organization and automate compliance status reporting."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: view compliance dashboards
lang: en-US
ignoreChecks: null
---
