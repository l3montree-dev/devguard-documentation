...
description: AboutCode vs DevGuard — key differences in philosophy, feature sets,
  integration approach, and use cases for open source security and compliance teams.
seo:
  robots: index,follow
  og:
    image: /og-image.png
