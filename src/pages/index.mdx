...
<div className="custom:flex custom:flex-row custom:items-center custom:justify-center custom:gap-4 custom:pt-4">
    <Image src="/question-gopher.png" alt="Question Gopher" width={200} height={200} className="custom:w-24 custom:h-auto" />
    <span className="custom:font-semibold custom:text-lg">
