---
title: Introduction
description: DevGuard is an open-source application security platform that integrates vulnerability scanning, SBOM management, and supply chain security into your DevOps workflow.
seo:
  keyword_primary: "open source application security platform"
  keywords_secondary:
    - "DevGuard security"
    - "vulnerability scanning DevOps"
    - "DevSecOps platform"
    - "SBOM management"
    - "supply chain security"
  og:
    title: "DevGuard — Open Source Application Security Platform"
    description: "Integrate vulnerability scanning, SBOM management, and supply chain security into your DevOps workflow."
    type: "website"
---
