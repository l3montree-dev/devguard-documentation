---
title: "Introduction to DevGuard — Open-Source Application Security Platform"
description: "DevGuard is an open-source application security platform — integrating vulnerability scanning, SBOM management, and supply chain security for DevOps."
seo:
