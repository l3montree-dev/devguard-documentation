...
description: >-
  DevGuard is an open source application security platform integrating
  vulnerability scanning, SBOM management, and supply chain security for DevOps
  teams.
seo:
  robots: 'index,follow'
  og:
    ...
    description: >-
      DevGuard is an open source application security platform integrating
      vulnerability scanning, SBOM management, and supply chain security for
      DevOps teams.
    image: /og-image.png
    type: website
    schema:
