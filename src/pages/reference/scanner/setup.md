---
title: devguard-scanner intoto setup — DevGuard CLI Reference
description: Reference for the devguard-scanner intoto setup command — DevGuard CLI tool for SBOM, SARIF, and attestation workflows in DevSecOps pipelines.
seo:
