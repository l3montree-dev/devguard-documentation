...
description: >-
  Reference for the DevGuard code-risk-Code Risk identification GitLab component
  — analyze SARIF files to identify security vulnerabilities in code
seo:
  robots: 'index,follow'
  og:
    title: Code Risk Identification GitLab Component
    description: >-
      Reference for the DevGuard code-risk-Code Risk identification GitLab
      component — analyze SARIF files to identify security vulnerabilities in
      code
    image: /og-image.png
    type: article
    schema:
