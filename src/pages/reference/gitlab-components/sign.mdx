...
description: "Reference for the DevGuard sign GitLab component — sign artifacts to ensure code integrity, generate cryptographic attestations, and verify supply chain."
seo:
  robots: index,follow
  og:
    image: /og-image.png
