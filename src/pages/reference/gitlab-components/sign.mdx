...
description: >-
  Sign GitLab Component DevGuard: Reference for the DevGuard sign GitLab
  component — sign artifacts to ensure code integrity, generate cryptographic…
seo:
  robots: 'index,follow'
  og:
    title: Sign GitLab Component DevGuard
    description: >-
      Sign GitLab Component DevGuard: Reference for the DevGuard sign GitLab
      component — sign artifacts to ensure code integrity, generate
      cryptographic…
    image: /og-image.png
    type: article
    schema:
