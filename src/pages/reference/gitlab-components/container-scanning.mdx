...
description: Reference for the DevGuard container-scanning GitLab component — scan Docker images for vulnerabilities in CI/CD
seo:
  ...
  og:
    title: "Container Scanning GitLab Component | DevGuard"
    description: "Reference for the DevGuard container-scanning GitLab component — scan Docker images for vulnerabilities in CI/CD."
    type: "article"
---
