---
title: SAST GitLab Component DevGuard
description: >-
  Configure the DevGuard SAST GitLab component devguard component to scan source
  code for vulnerabilities. See all available inputs, defaults, and.
seo:
  robots: 'index,follow'
  og:
    title: SAST GitLab Component DevGuard
    description: >-
      Configure the DevGuard SAST GitLab component devguard component to scan
      source code for vulnerabilities. See all available inputs, defaults, and.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
