---
title: Full DevGuard Scan GitLab Component
description: Reference for the DevGuard full-scan GitLab component — run comprehensive security scanning including container, SAST, SCA, and secrets
seo:
  ...
  og:
    title: "Full DevGuard Scan GitLab Component | DevGuard"
    description: "Reference for the DevGuard full-scan GitLab component — comprehensive security scanning in CI/CD."
    type: "article"
---
