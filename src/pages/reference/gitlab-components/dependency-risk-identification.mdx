...
description: Reference for the DevGuard dependency-risk-identification GitLab component — analyze SBOM for vulnerable dependencies
seo:
  keyword_primary: "dependency risk GitLab component"
  keywords_secondary:
    - "SBOM vulnerability analysis"
    - "dependency scanning CI/CD"
    - "GitLab dependency security"
  og:
    title: "Dependency Risk Identification GitLab Component | DevGuard"
    description: "Reference for the DevGuard dependency-risk-identification GitLab component — analyze SBOM for vulnerable dependencies."
    type: "article"
---
