---
title: Dependency Risk GitLab Component
description: >-
  Dependency Risk GitLab Component: Reference for the DevGuard
  dependency-risk-identification GitLab component — analyze third-party
  dependencies for CVEs and…
seo:
  robots: 'index,follow'
  og:
    title: Dependency Risk GitLab Component
