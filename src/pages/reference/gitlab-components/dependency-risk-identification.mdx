---
title: Dependency Risk Identification GitLab Component
description: Explore the dependency risk identification gitlab component documentation.
  Learn about vulnerability management and compliance with DevGuard open-source platf
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: dependency risk identification gitlab component
lang: en-US
ignoreChecks: null
---
