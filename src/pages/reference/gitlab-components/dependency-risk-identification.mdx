...
description: "Reference for the DevGuard dependency-risk-identification GitLab component — analyze third-party dependencies for CVEs and generate SBOMs in your pipeline."
seo:
  robots: index,follow
  og:
    image: /og-image.png
