...
description: Reference for the DevGuard build-image GitLab component — build and archive Docker images with Kaniko in CI/CD
seo:
  ...
  og:
    title: "Build Image GitLab Component | DevGuard"
    description: "Reference for the DevGuard build-image GitLab component — build and archive Docker images with Kaniko."
    type: "article"
---
