...
description: >-
  Build Image GitLab Component: Reference for the DevGuard build-image GitLab
  component — build and archive Docker images using Kaniko with integrated
  tagging…
seo:
  robots: 'index,follow'
  og:
    title: Build Image GitLab Component
    description: >-
      Build Image GitLab Component: Reference for the DevGuard build-image
      GitLab component — build and archive Docker images using Kaniko with
      integrated tagging…
    image: /og-image.png
    type: article
    schema:
