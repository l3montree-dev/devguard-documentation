...
description: >-
  Reference for the DevGuard secret-Secret scanning GitLab component — detect
  leaked API keys, passwords, and credentials in source code and git history.
seo:
  robots: 'index,follow'
  og:
    title: Secret Scanning GitLab Component
    description: >-
      Reference for the DevGuard secret-Secret scanning GitLab component —
      detect leaked API keys, passwords, and credentials in source code and git
      history.
    image: /og-image.png
    type: article
    schema:
