...
description: "Reference for the DevGuard secret-scanning GitLab component — detect leaked API keys, passwords, and credentials in source code and git history."
seo:
  robots: index,follow
  og:
    image: /og-image.png
