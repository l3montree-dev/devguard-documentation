---
title: Secret Scanning GitLab Component
description: Reference for the DevGuard secret-scanning GitLab component — detect leaked API keys, passwords, and secrets in source code
seo:
  keyword_primary: "secret scanning GitLab component"
  keywords_secondary:
    - "API key leak detection CI"
    - "GitLab secrets scanning"
    - "credential exposure prevention"
  og:
    title: "Secret Scanning GitLab Component | DevGuard"
    description: "Reference for the DevGuard secret-scanning GitLab component — detect leaked credentials and secrets in source code."
    type: "article"
---
