---
title: IaC GitHub Actions Workflow
description: >-
  Reference for the DevGuard IaC GitHub Actions workflow — scan infrastructure
  code for security misconfigurations and policy violations using SARIF
  reporting.
seo:
  robots: 'index,follow'
  og:
    title: IaC GitHub Actions Workflow
    description: >-
      Reference for the DevGuard IaC GitHub Actions workflow — scan
      infrastructure code for security misconfigurations and policy violations
      using SARIF reporting.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: IaC GitHub Actions workflow
lang: en-US
ignoreChecks:
