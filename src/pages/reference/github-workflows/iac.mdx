...
description: Reference for the DevGuard IaC GitHub Actions workflow — scan infrastructure code for security misconfigurations
seo:
  ...
  og:
    title: "IaC GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard IaC GitHub Actions workflow — scan infrastructure code for security misconfigurations."
    type: "article"
---
