---
title: Infrastructure as Code (IaC) GitHub Workflow
description: "Reference for the DevGuard IaC GitHub Actions workflow — scan infrastructure code for security misconfigurations and policy violations using SARIF reporting."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: infrastructure as code (iac) github
lang: en-US
ignoreChecks: null
---
...
jobs:
    devguard-iac:
        uses: l3montree-dev/devguard-ci-components/.github/workflows/iac.yml@main
        with:
