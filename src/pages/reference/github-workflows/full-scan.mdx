---
title: Full DevGuard Scan GitHub Workflow
description: Reference for the DevGuard full-scan GitHub Actions workflow — comprehensive security scanning including container, SAST, SCA, and secrets
seo:
  keyword_primary: "full security scan GitHub workflow"
  keywords_secondary:
    - "comprehensive DevGuard scan"
    - "GitHub security pipeline"
    - "all-in-one security scan CI"
  og:
    title: "Full DevGuard Scan GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard full-scan GitHub Actions workflow — comprehensive security scanning in CI/CD."
    type: "article"
---
