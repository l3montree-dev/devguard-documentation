...
description: >-
  Reference for the DevGuard deploy GitHub Actions workflow — deploy OCI images
  to your infrastructure with security validation and attestation checks.
seo:
  robots: 'index,follow'
  og:
    title: Deploy GitHub Actions Workflow
    description: >-
      Reference for the DevGuard deploy GitHub Actions workflow — deploy OCI
      images to your infrastructure with security validation and attestation
      checks.
    image: /og-image.png
    type: article
    schema:
