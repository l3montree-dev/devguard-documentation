...
description: Reference for the DevGuard deploy GitHub Actions workflow — deploy OCI images to container registry after security checks pass
seo:
  keyword_primary: "deploy GitHub Actions workflow"
  keywords_secondary:
    - "GitHub container registry deploy"
    - "secure deployment pipeline"
    - "OCI image deployment GitHub"
  og:
    title: "Deploy GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard deploy GitHub Actions workflow — deploy OCI images after security checks pass."
    type: "article"
---
