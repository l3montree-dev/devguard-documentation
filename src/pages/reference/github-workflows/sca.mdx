...
description: "Reference for the DevGuard SCA GitHub Actions workflow — detect vulnerabilities in third-party dependencies and generate SBOMs for software composition."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: software composition analysis (sca) github
lang: en-US
ignoreChecks: null
---
...
jobs:
    devguard-sca:
        uses: l3montree-dev/devguard-ci-components/.github/workflows/sca.yml@main
        with:
