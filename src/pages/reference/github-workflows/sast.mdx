---
title: SAST GitHub Actions Workflow
description: >-
  Reference for the DevGuard SAST GitHub Actions workflow — analyze source code
  for security vulnerabilities using static analysis and SARIF report
  integration.
seo:
  robots: 'index,follow'
  og:
    title: SAST GitHub Actions Workflow
    description: >-
      Reference for the DevGuard SAST GitHub Actions workflow — analyze source
      code for security vulnerabilities using static analysis and SARIF report
      integration.
    image: /og-image.png
    type: article
    schema:
