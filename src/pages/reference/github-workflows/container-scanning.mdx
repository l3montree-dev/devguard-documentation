...
description: >-
  Container Scanning GitHub Workflow: Reference for the DevGuard
  container-scanning GitHub Actions workflow — scan Docker images for known CVEs
  and generate…
seo:
  robots: 'index,follow'
  og:
    ...
    description: >-
      Container Scanning GitHub Workflow: Reference for the DevGuard
      container-scanning GitHub Actions workflow — scan Docker images for known
      CVEs and generate…
    image: /og-image.png
    type: article
    schema:
