...
description: "Reference for the DevGuard dependency-risk-identification GitHub Actions workflow — detect vulnerable third-party dependencies and generate SBOMs in CI/CD."
seo:
  robots: index,follow
  og:
    image: /og-image.png
