---
title: Dependency Risk GitHub Workflow
description: >-
  Dependency Risk GitHub Workflow: Reference for the DevGuard
  dependency-risk-identification GitHub Actions workflow — detect vulnerable
  third-party…
seo:
  robots: 'index,follow'
  og:
