...
seo:
  ...
  keywords_secondary:
    - "SARIF analysis GitHub Actions"
    - "GitHub code security workflow"
    - "code vulnerability identification CI"
  og:
    title: "Code Risk Identification GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard code-risk-identification GitHub Actions workflow — analyze SARIF files for security vulnerabilities."
    type: "article"
---
