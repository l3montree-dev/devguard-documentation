...
description: Reference for the DevGuard build-image GitHub Actions workflow — build and archive Docker images with Kaniko
seo:
  keyword_primary: "build image GitHub workflow"
  keywords_secondary:
    - "Kaniko Docker build GitHub"
    - "GitHub container build pipeline"
    - "OCI image build Actions"
  og:
    title: "Build Image GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard build-image GitHub Actions workflow — build and archive Docker images with Kaniko."
    type: "article"
---
