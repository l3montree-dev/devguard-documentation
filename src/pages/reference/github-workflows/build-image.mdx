---
title: Build Image GitHub Workflow
description: "Reference for the DevGuard build-image GitHub Actions workflow — build and archive Docker images with Kaniko, artifact upload, and digest tracking."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: build image GitHub workflow
lang: en-US
ignoreChecks: null
---
...
jobs:
    devguard-build-image:
        uses: l3montree-dev/devguard-ci-components/.github/workflows/build-image.yml@main
        with:
