...
description: >-
  Reference for the DevGuard secret scanning github workflow-scanning GitHub
  Actions workflow — detect leaked API keys, passwords, and secrets in source
  code
seo:
  robots: 'index,follow'
  og:
    ...
    description: >-
      Reference for the DevGuard secret scanning github workflow-scanning GitHub
      Actions workflow — detect leaked API keys, passwords, and secrets in
      source code
    image: /og-image.png
    type: article
    schema:
