---
title: Sign GitHub Actions Workflow
description: >-
  Reference for the DevGuard sign GitHub Actions workflow — sign artifacts to
  ensure code integrity, generate attestations, and verify supply chain.
seo:
  robots: 'index,follow'
  og:
    title: Sign GitHub Actions Workflow
    description: >-
      Reference for the DevGuard sign GitHub Actions workflow — sign artifacts
      to ensure code integrity, generate attestations, and verify supply chain.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
