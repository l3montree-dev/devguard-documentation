...
description: Reference for the DevGuard sign GitHub Actions workflow — sign artifacts to ensure code integrity and deployment trust
seo:
  ...
  og:
    title: "Sign GitHub Workflow | DevGuard"
    description: "Reference for the DevGuard sign GitHub Actions workflow — sign artifacts to ensure code integrity."
    type: "article"
---
