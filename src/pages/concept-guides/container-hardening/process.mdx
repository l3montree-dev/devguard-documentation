...
Follow the process described in the [Container Hardening CVE Decision Guide](/concept-guides/container-hardening/cve-decision)
...
[Container Hardening CVE Decision Guide](/concept-guides/container-hardening/cve-decision) to handle them.
