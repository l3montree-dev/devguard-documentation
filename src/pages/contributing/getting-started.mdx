...
<Alert className="custom:mt-4 custom:grid custom:w-full custom:max-w-xl custom:items-start custom:gap-4" variant="default | destructive">
  <LucideInfo className="custom:h-4 custom:w-4" />
  <AlertDescription>
