...
Once integrated, the DevGuard CI/CD pipeline will scan your codebase, identify flaws,
and provide attestation and evidence for completed checks.

On DevGuard, you can manage, prioritize, and resolve flaws, achieve compliance, and
...
The checks will report via SBOM or SARIF-report flaws to DevGuard. DevGuard
will help you manage, prioritize, and resolve found flaws.
...
### Flaw Management & Issue Synchronization

DevGuard provides a centralized view of all flaws in your codebase, allowing you to
prioritize and manage them effectively. Based on the aggregated vulnerability database,
you can see the risk level of each flaw and prioritize them accordingly.
...
can also handle the flaw management process via slash commands.

Learn more in the [Flaw Management](/concepts/flaw-management) section.
