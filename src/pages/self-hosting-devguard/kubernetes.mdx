...
2. **Create necessary existing secrets**
    - DevGuard requires it's own private key to sign In-Toto Root-Layouts (Refer to the [In-Toto Whitepaper](/concepts/in-toto)).
       ```bash
