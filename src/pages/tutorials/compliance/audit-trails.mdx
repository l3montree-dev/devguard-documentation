...
description: "Track and review all security events and actions in DevGuard's immutable audit trail — generating compliance reports and evidence for regulatory requirements."
seo:
  robots: index,follow
  og:
    image: /og-image.png
...
![DevGuard Activity Stream](/screenshots/screenshot-vulnerability-event-actions.png)
...
Both endpoints return paginated JSON and support filtering by event type, date range, and vulnerability ID. Use a [Personal Access Token](/explanations/personal-access-token) for authentication.
...
- [VEX: Vulnerability Exploitability eXchange](/explanations/compliance/csaf-vex-explained) — how DevGuard generates VEX documents from your audit trail
