---
title: Container Hardening Process
description: >-
  Container Hardening Process: Structured process for systematically hardening
  container images with automated DevGuard scanning, vulnerability triage, and…
seo:
  robots: 'index,follow'
  og:
    title: Container Hardening Process
    description: >-
      Container Hardening Process: Structured process for systematically
      hardening container images with automated DevGuard scanning, vulnerability
      triage, and…
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: container hardening process
lang: en-US
ignoreChecks:
...
- Strive for **hardened build environments** (like defined in SLSA Level 3 - [SLSA Level 3 on GitLab](/explanations/attestations-provenance/slsa-level-3)).
...
(see the [OWASP DevSecOps Pipeline](/explanations/devsecops/understanding-owasp-devsecops-pipeline) for more details).
...
Follow the process described in the [Container Hardening CVE Decision Guide](/tutorials/container-hardening/cve-decision)
...
Another use case of the SBOM is to ensure your license compliance. A violation can lead to cuts for availability requirements
as well as legal issues. DevGuard can help you to identify and handle license compliance issues in your dependencies.
...
[Container Hardening CVE Decision Guide](/tutorials/container-hardening/cve-decision) to handle them.
...
Ensure your license compliance for the image and its components too. A violation can lead to cuts for availability requirements
as well as legal issues. DevGuard can help you to identify and handle license compliance issues.
...
(you can find details why in the [SBOM Problem Statement](/explanations/sbom-problem-statement)).
