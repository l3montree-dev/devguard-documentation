---
title: Base Image Attestation Discovery
description: >-
  Base Image Attestation Discovery: Automatically discover and extract
  attestations from container base images to inherit security metadata and
  verify…
seo:
  robots: 'index,follow'
  og:
