...
description: Automatically discover and extract attestations from container base images to ingest upstream vulnerability information
seo:
  keyword_primary: "base image attestation discovery"
  keywords_secondary:
    - "container attestation extraction"
    - "upstream vulnerability ingestion"
    - "Dockerfile base image VEX"
  og:
    title: "Discovering Base Image Attestations | DevGuard"
    description: "Automatically discover and extract attestations from container base images to ingest upstream vulnerability information."
    type: "article"
---
