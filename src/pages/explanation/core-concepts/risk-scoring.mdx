...
<Callout type="info" emoji="🔄">
  For complete details on the risk calculation methodology, vulnerability dimensions, and best practices, see the [Vulnerability Risk Assessment Methodology](risk-assessment-methodology) documentation.
</Callout>
...
- [Vulnerability Risk Assessment Methodology](risk-assessment-methodology) - Complete risk calculation details
- [Vulnerability Lifecycle](vulnerability-lifecycle) - Managing vulnerabilities
- [Dependency vs First-Party Risk](dependency-first-party-risk) - Understanding risk sources