...
<Callout type="info" emoji="🔄">
  For complete details on the risk calculation methodology, vulnerability dimensions, and best practices, see the [Vulnerability Risk Assessment Methodology](/explanation/vulnerability-management/risk-assessment-methodology) documentation.
</Callout>
...
- [Vulnerability Risk Assessment Methodology](/explanation/vulnerability-management/risk-assessment-methodology) - Complete risk calculation details
- [Vulnerability Lifecycle](/explanation/vulnerability-management/vulnerability-lifecycle) - Managing vulnerabilities
