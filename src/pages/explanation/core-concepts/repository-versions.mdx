...
4. DevGuard tracks progression automatically
...
1. Repository settings → select branches for tracking
2. Configure CIA requirements per branch if needed
3. Add DevGuard scanning to CI/CD pipeline per branch
4. Establish merge policies (which severities block merges)

---

## Related Documentation

- [DevGuard Hierarchy](devguard-hierarchy) - Organization, groups, repositories
