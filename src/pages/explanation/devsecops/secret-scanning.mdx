...
<Callout type="info" emoji="ℹ️">
  DevGuard performs secret scanning to identify sensitive information in your codebase, such as API keys, passwords, and other credentials (based on SARIF) - [Mitigation Guide](/concept-guides/risk-mitigation-guides/secret-scanning)
</Callout>
