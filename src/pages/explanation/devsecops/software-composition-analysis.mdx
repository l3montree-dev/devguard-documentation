...
<Callout type="info" emoji="ℹ️">
  DevGuard performs continous sca to identify vulnerabilities in your project's dependencies after your first scan (based on SBOM) - [Mitigation Guide](/concept-guides/risk-mitigation-guides/software-composition-analysis)
</Callout>
