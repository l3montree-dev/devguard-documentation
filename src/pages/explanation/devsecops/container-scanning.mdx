...
<Callout type="info" emoji="ℹ️">
  DevGuard performs continous container scanning to identify vulnerabilities in your project's container images after your first scan (based on SBOM) - [Mitigation Guide](/concept-guides/risk-mitigation-guides/container-scanning)
</Callout>
