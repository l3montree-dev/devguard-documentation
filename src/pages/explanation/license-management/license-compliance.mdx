...
## DevGuard License Management

DevGuard automatically detects and tracks licenses:

- License detection during SBOM generation
- Compatibility analysis flagging conflicts
- Compliance reporting for attribution/disclosure requirements
- Risk assessment categorizing dependencies by license risk

---

## Related Documentation

- [SBOM Standards](/explanation/compliance/sbom-standards) - License information in SBOMs
- [Why Compliance Matters](/explanation/compliance/why-compliance-matters) - Business case
