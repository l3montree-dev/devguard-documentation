...
in the [DevSecOps](/other/concepts/devsecops/understanding-owasp-devsecops-pipeline) section.
...
Learn more about the [aggregated vulnerability database](/other/concepts/aggregated-vulnerability-database)
and how it works.
...
Learn more in the [Vulnerability Management](/other/concepts/vulnerability-management) section.
...
Learn more in the [Attestation & Provenance](/other/concepts/attestations-provenance)
section. 
