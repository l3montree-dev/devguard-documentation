...
This workflow identifies potential security vulnerabilities in your codebase.
It requires a **sarif file** as input to analyze and ensure that all code is secure and up to date.
