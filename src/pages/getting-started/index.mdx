---
title: DevGuard Quick Start Guide
description: >-
  Get started with the DevGuard quick start guide and run your first security
  scan in minutes — open-source platform for vulnerability and SBOM management.
seo:
  robots: 'index,follow'
  og:
    title: DevGuard Quick Start Guide
    description: >-
      Get started with the DevGuard quick start guide and run your first
      security scan in minutes — open-source platform for vulnerability and SBOM
      management.
    image: /og-image.png
    type: article
    schema:
      type: WebSite
  keyword_primary: DevGuard quick start guide
lang: en-US
ignoreChecks:
