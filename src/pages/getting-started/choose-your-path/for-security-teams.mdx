...
description: >-
  DevGuard For Security Teams: How security teams use DevGuard to gain
  organization-wide vulnerability visibility, enforce policies, and communicate.
seo:
  robots: 'index,follow'
  og:
    title: DevGuard for Security Teams
    description: >-
      DevGuard For Security Teams: How security teams use DevGuard to gain
      organization-wide vulnerability visibility, enforce policies, and
      communicate.
    image: /og-image.png
    type: article
    schema:
