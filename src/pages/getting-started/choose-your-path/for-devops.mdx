---
title: DevGuard for DevOps Guide
...
See [Dependency Proxy setup](/how-to-guides/dependency-proxy) for per-ecosystem configuration.
...
6. **Configure the [dependency proxy](/how-to-guides/dependency-proxy)** for your build environments to block malicious packages
