...
### Generate a new access token on GitLab
    ...
    Go to Project you want to integrate it with Devguard on GitLab. 
...
Add a name for the instance, the URL of your GitLab instance, and the access token you generated in the previous step.
...
Now you have successfully integrated your GitLab project with DevGuard. You can integrate the CI/CD pipeline with DevGuard from the security control center of the asset on DevGuard. 