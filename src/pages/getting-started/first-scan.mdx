---
title: "Run Your First Dependency Scan with DevGuard"
description: "Run first dependency scan DevGuard — a step-by-step guide to setting up the scanner, executing your first SCA scan, and interpreting the results."
seo:
...
lang: "en-US"
og:
  title: "Run First Dependency Scan DevGuard Guide"
  description: "Run first dependency scan DevGuard — a step-by-step guide to setting up the scanner, executing your first SCA scan, and interpreting the results."
  image: "/og-image.png"
  type: "article"
  schema:
