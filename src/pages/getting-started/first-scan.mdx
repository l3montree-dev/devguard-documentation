---
title: Your First Vulnerability Scan
description: "Run your first dependency scan with DevGuard — a step-by-step guide to setting up the scanner, executing your first SCA scan, and interpreting the results."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: vulnerability scan
lang: en-US
ignoreChecks: null
---
...
# Your First Vulnerability Scan with DevGuard
...
Now that you've completed your first scan, see [Scan Your Project](/how-to-guides/scanning/scan-your-project) for the full reference on source code scanning, container image scanning, SBOM upload, and CI/CD integration — or jump to [DevGuard's Key Concepts](/getting-started/key-concepts) to understand risk scoring and the vulnerability lifecycle.
