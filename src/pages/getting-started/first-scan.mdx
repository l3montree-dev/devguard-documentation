---
title: Run First Dependency Scan DevGuard
description: >-
  Run first dependency scan DevGuard — a step-by-step guide to setting up the
  scanner, executing your first SCA scan, and interpreting the results.
seo:
  robots: 'index,follow'
  og:
    title: Run First Dependency Scan DevGuard
    description: >-
      Run first dependency scan DevGuard — a step-by-step guide to setting up
      the scanner, executing your first SCA scan, and interpreting the results.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: run first dependency scan DevGuard
lang: en-US
ignoreChecks:
