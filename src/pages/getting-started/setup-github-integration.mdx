...
You can find more information about the DevGuard Personal Access Token [here](/concepts/personal-access-token).
...
Manage your security settings and monitor your codebase using DevGuard. For more information, refer to the [Mange Risks](/basics/mangeRisks) guide.


#### Related Articles

- [Personal Access Token](/concepts/personal-access-token)
- [Manage Risks](/guides/mangeRisks)
