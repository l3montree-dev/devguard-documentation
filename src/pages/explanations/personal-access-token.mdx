...
description: >-
  Learn how DevGuard personal access tokens (PATs) work — creating, scoping, and
  using tokens for API authentication and CI/CD pipeline integration.
seo:
  robots: 'index,follow'
  og:
    title: DevGuard Personal Access Token Guide
    description: >-
      Learn how DevGuard personal access tokens (PATs) work — creating, scoping,
      and using tokens for API authentication and CI/CD pipeline integration.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
