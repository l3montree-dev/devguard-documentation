...
seo:
  ...
  keyword_primary: database schema
  og:
    image: /og-image.png
    type: article
  schema:
    type: TechArticle
title: DevGuard Database Schema
description: Explore the DevGuard Database Schema documentation. Explore supply chain
...
For details on how this data is imported and kept up to date, see [External Vulnerability Synchronization](/how-to-guides/vulnerability-management/sync-external-data).
