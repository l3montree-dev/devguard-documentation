---
title: DevGuard Authentication Architecture
description: >-
  DevGuard Authentication Architecture: How DevGuard handles authentication
  using Ory Kratos for session management, Personal Access Tokens for API
  access, and…
seo:
  robots: 'index,follow'
  og:
