...
seo:
  keyword_primary: "DevGuard authentication architecture"
  keywords_secondary:
    - "Ory Kratos session management"
    - "personal access token API"
    - "Casbin RBAC authorization"
    - "OAuth DevGuard"
  og:
    title: "Authentication Flow | DevGuard"
    description: "DevGuard's multi-layered authentication: Ory Kratos, Personal Access Tokens, and Casbin RBAC."
    type: "article"
---
