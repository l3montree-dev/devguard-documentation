...
- **Generate an [SBOM](/explanations/supplementary-sboms)** for every build and store it next to the artifact. You cannot react to the next Log4Shell if you don't know which of your services contain the vulnerable library.
