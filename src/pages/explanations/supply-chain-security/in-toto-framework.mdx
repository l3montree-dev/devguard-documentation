---
title: The In-Toto Framework
description: How the in-toto framework secures software supply chains by linking each step in the build process with cryptographic guarantees, preventing tampering between stages.
seo:
  keyword_primary: "in-toto supply chain framework"
  keywords_secondary:
    - "in-toto attestation"
  ...
  og:
    title: "The In-Toto Framework | DevGuard"
    description: "How in-toto links build steps with cryptographic guarantees to prevent supply chain tampering."
    type: "article"
---
