...
description: "Understand the SLSA (Supply chain Levels for Software Artifacts) security framework, a maturity model to harden your build process against attacks."
seo:
  robots: index,follow
  og:
    image: /og-image.png
