...
description: Understand SLSA (Supply chain Levels for Software Artifacts) — the security maturity model for grading build process security and hardening against supply chain attacks.
seo:
  ...
  og:
    title: "The SLSA Framework | DevGuard"
    description: "SLSA — the maturity model for grading build security and hardening against supply chain attacks."
    type: "article"
---
