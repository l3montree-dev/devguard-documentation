...
description: How to perform software supply chain verification — checking SBOM signatures,
  attestations, and provenance records to confirm artifacts haven't been tampered.
seo:
  robots: index,follow
  og:
    image: /og-image.png
