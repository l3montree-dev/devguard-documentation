...
description: "How to perform software supply chain verification — checking SBOM signatures, attestations, and provenance records to confirm artifacts haven't been tampered."
seo:
  robots: "index,follow"
  og:
    title: "Software Supply Chain Verification with DevGuard"
