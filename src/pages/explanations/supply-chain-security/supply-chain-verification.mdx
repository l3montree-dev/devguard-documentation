...
Creating secure software is only half the battle. You can generate SBOMs, sign your commits, and attach sophisticated [Attestations](/explanation/supply-chain-security/attestations) to your artifacts, but none of this matters if nobody checks them.
