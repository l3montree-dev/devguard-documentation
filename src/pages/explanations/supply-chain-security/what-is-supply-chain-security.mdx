...
seo:
  ...
  keywords_secondary:
    ...
    - "SBOM supply chain"
  og:
    title: "What is Supply Chain Security? | DevGuard"
    description: "Supply chain security for software — threats, risks, and how to mitigate them in your development lifecycle."
    type: "article"
---
