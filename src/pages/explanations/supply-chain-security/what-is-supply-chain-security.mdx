...
[**Supply-chain Levels for Software Artifacts (SLSA)**](/explanations/supply-chain-security/slsa-framework.mdx) is a framework specifically designed to guarantee the integrity of the final software output.
...
In the following sections, we will explore the specific frameworks **DevGuard** uses to implement these concepts, including [In-toto](/explanations/in-toto-framework.mdx) and [SLSA](/explanations/slsa-framework.mdx).
