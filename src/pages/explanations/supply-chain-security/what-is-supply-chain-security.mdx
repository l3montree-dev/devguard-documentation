...
description: >-
  Learn what software supply chain security means, which threats exist, and how
  DevGuard helps teams mitigate risks across the software development lifecycle.
seo:
  robots: 'index,follow'
  og:
    title: What is Software Supply Chain Security?
    description: >-
      Learn what software supply chain security means, which threats exist, and
      how DevGuard helps teams mitigate risks across the software development
      lifecycle.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: software supply chain security
lang: en-US
ignoreChecks:
