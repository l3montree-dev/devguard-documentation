...
description: "Learn what software supply chain security means, which threats exist, and how DevGuard helps teams mitigate risks across the software development lifecycle."
seo:
  robots: index,follow
  og:
    image: /og-image.png
...
![Software Supply Chain Threat Model](/Software-Supply-Chain-Threat-Modeling.png)
