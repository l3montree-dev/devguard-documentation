...
description: >-
  What are software supply chain attestations? Learn how signed statements about
  build artifacts enable explicit verification in a zero-trust supply chain.
seo:
  robots: 'index,follow'
  og:
    title: Supply Chain Attestations
    description: >-
      What are software supply chain attestations? Learn how signed statements
      about build artifacts enable explicit verification in a zero-trust supply
      chain.
    image: /og-image.png
    type: article
    schema:
