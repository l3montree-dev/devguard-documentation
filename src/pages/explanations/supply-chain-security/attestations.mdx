...
description: What are software supply chain attestations? Learn how signed statements about build artifacts enable explicit verification in a zero-trust supply chain security model.
seo:
  keyword_primary: "supply chain attestations"
  keywords_secondary:
    - "signed software attestation"
    - "in-toto attestation"
    - "build provenance verification"
    - "artifact trust chain"
  og:
    title: "Supply Chain Attestations | DevGuard"
    description: "How signed attestations enable explicit verification of software artifacts in supply chain security."
    type: "article"
---
# Attestations
