---
title: Organizations, Groups & Repositories
description: Learn how DevGuard organizes security management through a three-level hierarchy — Organizations, Groups, and Repositories — for portfolio-wide vulnerability management.
seo:
  keyword_primary: "DevGuard organizations groups repositories"
  keywords_secondary:
    - "security portfolio management"
    - "multi-project vulnerability tracking"
    - "DevGuard hierarchy"
    - "access control structure"
  og:
    title: "Organizations, Groups & Repositories | DevGuard"
    description: "How DevGuard organizes security with a three-level hierarchy for portfolio-wide vulnerability management."
    type: "article"
---
...
**Scanning**: This is what DevGuard Scanner analyzes—identifying components, generating <Tooltip><TooltipTrigger asChild><span className="underline decoration-dotted decoration-yellow-400 decoration-1 underline-offset-4 cursor-pointer">SBOM</span></TooltipTrigger><TooltipContent><p>Software Bill of Materials - Component inventory</p></TooltipContent></Tooltip>, detecting vulnerabilities.
...
- [Vulnerability Lifecycle](/explanations/vulnerability-management/vulnerability-lifecycle) - Managing vulnerabilities across hierarchy