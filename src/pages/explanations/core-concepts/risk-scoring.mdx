---
title: "Risk Scoring"
description: "Learn how DevGuard calculates multi-dimensional risk scores using CVSS, EPSS, and contextual factors to prioritize vulnerabilities by actual threat — not."
seo:
