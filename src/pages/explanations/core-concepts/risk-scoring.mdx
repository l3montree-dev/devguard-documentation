...
description: Learn how DevGuard calculates vulnerability risk scoring using CVSS,
  EPSS, and contextual factors to prioritize by actual threat, not just severity.
seo:
  robots: index,follow
  og:
    image: /og-image.png
