...
description: Understand how DevGuard tracks vulnerabilities across multiple build artifacts — Docker images, distributions, and deployment targets — from a single repository.
seo:
  keyword_primary: "DevGuard artifact tracking"
  keywords_secondary:
    - "build artifact vulnerability"
    - "Docker image scanning"
    - "multi-artifact security"
    - "dependency tree artifacts"
  og:
    title: "Artifact Concept | DevGuard"
    description: "How DevGuard tracks vulnerabilities across multiple build artifacts from a single repository."
    type: "article"
---
