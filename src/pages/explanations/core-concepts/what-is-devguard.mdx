---
title: What is DevGuard? Open-Source Security Platform
description: >-
  What is DevGuard? An open-source vulnerability management platform built for
  developers to integrate security into the software development lifecycle.
seo:
  robots: 'index,follow'
  og:
    title: What is DevGuard? Open-Source Security Platform
    description: >-
      What is DevGuard? An open-source vulnerability management platform built
      for developers to integrate security into the software development
      lifecycle.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: what is DevGuard
lang: en-US
ignoreChecks:
