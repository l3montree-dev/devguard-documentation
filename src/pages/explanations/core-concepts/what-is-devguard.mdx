...
description: DevGuard is an open-source vulnerability management platform built for developers. Learn how it integrates security into your software development lifecycle.
seo:
  ...
  og:
    title: "What is DevGuard? | DevGuard Docs"
    description: "DevGuard is an open-source vulnerability management platform built by developers, for developers."
    type: "article"
---
