...
**DevGuard**: Document Not Affected assessments, publish all three formats from the same decisions, consume supplier VEX and CSAF as [VEX rules](/how-to-guides/vex/vex-rules).
