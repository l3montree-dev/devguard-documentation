...
**Formats**: CycloneDX (JSON/XML), SPDX (JSON/YAML) <span className="custom:text-sm custom:text-gray-500">Coming Soon</span>
...
Standardized format for static analysis findings including <Tooltip><TooltipTrigger asChild><span className="custom:underline custom:decoration-dotted custom:decoration-yellow-400 custom:decoration-1 custom:underline-offset-4 custom:cursor-pointer">SAST</span></TooltipTrigger><TooltipContent><p>Static Application Security Testing - Code vulnerability analysis</p></TooltipContent></Tooltip>, secret scanning, and code quality issues.
