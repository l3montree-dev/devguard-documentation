...
description: "DevGuard uses open standards security toolchain — SBOM, VEX, SARIF, SLSA — ensuring maximum compatibility and avoiding vendor lock-in across integrations."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: open standards first
lang: en-US
ignoreChecks: null
---
...
**Formats**: CycloneDX VEX (JSON/XML), CSAF VEX (JSON), OpenVEX (JSON)
...
[Learn more →](/explanations/vulnerability-management/what-is-vex)
...
- [External Vulnerability Sync](/how-to-guides/vulnerability-management/sync-external-data) - Importing/exporting data