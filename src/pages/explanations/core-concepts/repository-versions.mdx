...
description: DevGuard tracks vulnerabilities across multiple branches and tags, mirroring your Git workflow with independent security findings per branch.
seo:
  keyword_primary: "vulnerability tracking git branches"
  keywords_secondary:
    - "DevGuard branch scanning"
    - "per-branch vulnerability management"
    - "security across releases"
    - "tag vulnerability tracking"
  og:
    title: "Repository Versions (Branches & Tags) | DevGuard"
    description: "Track vulnerabilities independently per branch or tag, mirroring your Git workflow in DevGuard."
    type: "article"
---
