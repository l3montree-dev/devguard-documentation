---
title: Vulnerability Tracking Git Branches
description: >-
  Vulnerability tracking git branches and tags in DevGuard — independent
  security findings per branch and tag that mirror your Git workflow.
seo:
  robots: 'index,follow'
  og:
    title: Vulnerability Tracking Git Branches
