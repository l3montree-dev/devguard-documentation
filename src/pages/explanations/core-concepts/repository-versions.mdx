---
title: Repository Versions (Branches & Tags)
description: "Vulnerability tracking git branches and tags in DevGuard — independent security findings per branch and tag that mirror your Git workflow."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: repository versions (branches & tags)
lang: en-US
ignoreChecks: null
---
...
<Callout type="info">
  Inactive branches are deleted after a grace period (the default branch and tags are always kept). 
</Callout>
...
<Callout type="info">
  If you create a new branch or tag, it is always initalized with the vulnerability status of the `main` branch at the time of creation.
</Callout>
...
- [DevGuard Hierarchy](/explanations/core-concepts/organization-groups-repos) - Organization, groups, repositories
- [Vulnerability Lifecycle](/explanations/vulnerability-management/vulnerability-lifecycle) - Managing vulnerabilities
- [Vulnerability Types](/explanations/core-concepts/vulnerability-types)
