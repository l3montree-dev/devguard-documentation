...
description: Understand DAST — how DevGuard integrates dynamic application security
  testing to find runtime vulnerabilities by actively probing running applications.
seo:
  robots: index,follow
  og:
    image: /og-image.png
