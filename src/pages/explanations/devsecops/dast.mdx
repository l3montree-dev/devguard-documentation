...
seo:
  keyword_primary: "dynamic application security testing DAST"
  keywords_secondary:
    ...
    - "DevGuard DAST"
  og:
    title: "Dynamic Application Security Testing (DAST) | DevGuard"
    description: "How DAST finds runtime vulnerabilities by actively probing running applications in DevGuard."
    type: "article"
---
