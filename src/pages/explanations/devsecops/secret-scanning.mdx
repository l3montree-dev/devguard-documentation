---
title: Secret Scanning for Git Credentials
description: >-
  Learn how DevGuard performs secret scanning of source code and git history —
  detecting API keys, passwords, and tokens to prevent leaks in CI/CD pipelines.
seo:
  robots: 'index,follow'
  og:
    title: Secret Scanning for Git Credentials
    description: >-
      Learn how DevGuard performs secret scanning of source code and git history
      — detecting API keys, passwords, and tokens to prevent leaks in CI/CD
      pipelines.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: secret scanning
lang: en-US
ignoreChecks:
