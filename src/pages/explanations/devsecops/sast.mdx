...
description: "Understand static application security testing and how DevGuard integrates SAST tools to detect source code vulnerabilities before production using SARIF."
seo:
  keyword_primary: "static application security testing"
  keywords_secondary:
