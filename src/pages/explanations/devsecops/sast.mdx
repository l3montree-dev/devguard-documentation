...
description: Understand static application security testing and how DevGuard integrates
  SAST tools to detect source code vulnerabilities before production using SARIF.
seo:
  robots: index,follow
  og:
    image: /og-image.png
