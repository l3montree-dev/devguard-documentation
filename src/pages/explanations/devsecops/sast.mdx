...
description: Understand how DevGuard integrates SAST tools to detect security vulnerabilities in source code before they reach production, using SARIF for findings exchange.
seo:
  keyword_primary: "static application security testing SAST"
  keywords_secondary:
    ...
    - "DevGuard SAST"
  og:
    title: "Static Application Security Testing (SAST) | DevGuard"
    description: "How DevGuard integrates SAST to detect source code vulnerabilities using SARIF findings exchange."
    type: "article"
---
