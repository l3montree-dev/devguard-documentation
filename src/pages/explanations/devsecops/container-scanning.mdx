...
description: Learn how DevGuard scans Docker container images for vulnerabilities by analyzing the image's SBOM against known CVEs and security advisories.
seo:
  keyword_primary: "container image vulnerability scanning"
  keywords_secondary:
  ...
  og:
    title: "Container Scanning | DevGuard"
    description: "How DevGuard scans Docker container images for vulnerabilities using SBOM analysis."
    type: "article"
---
