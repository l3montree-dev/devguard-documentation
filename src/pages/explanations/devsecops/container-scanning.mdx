...
description: "Learn how DevGuard performs container image vulnerability scanning by analyzing Docker image SBOMs against known CVEs and security advisories."
seo:
  robots: index,follow
  og:
    image: /og-image.png
