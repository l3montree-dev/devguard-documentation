...
description: >-
  Understand software composition analysis and how DevGuard scans third-party
  dependencies for known CVEs, generates SBOMs, and tracks vulnerable
  components.
seo:
  robots: 'index,follow'
  og:
    title: Software Composition Analysis (SCA)
    description: >-
      Understand software composition analysis and how DevGuard scans
      third-party dependencies for known CVEs, generates SBOMs, and tracks
      vulnerable components.
    image: /og-image.png
    type: article
    schema:
      type: TechArticle
  keyword_primary: software composition analysis
lang: en-US
ignoreChecks:
