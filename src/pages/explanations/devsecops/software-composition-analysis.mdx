...
description: Understand software composition analysis and how DevGuard scans third-party
  dependencies for known CVEs, generates SBOMs, and tracks vulnerable components.
seo:
  robots: index,follow
  og:
    image: /og-image.png
