...
description: Understand how DevGuard's SCA scans third-party dependencies for known CVEs, generates SBOMs, and tracks vulnerable components across your software portfolio.
seo:
  keyword_primary: "software composition analysis SCA"
  keywords_secondary:
    ...
    - "DevGuard SCA"
  og:
    title: "Software Composition Analysis (SCA) | DevGuard"
    description: "How DevGuard's SCA detects CVEs in third-party dependencies and generates SBOMs for your portfolio."
    type: "article"
---
