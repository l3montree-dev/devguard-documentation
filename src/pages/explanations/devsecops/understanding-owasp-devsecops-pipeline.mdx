...
description: How DevGuard implements the OWASP DevSecOps pipeline — covering each
  security stage from SAST and SCA to container scanning and secret detection in CI/CD.
seo:
  robots: index,follow
  og:
    image: /og-image.png
