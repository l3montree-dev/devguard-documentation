...
description: Explore the infrastructure as code (iac) scanning documentation. Learn
  about vulnerability management and compliance with DevGuard open-source platform.
seo:
  robots: index,follow
  og:
    image: /og-image.png
