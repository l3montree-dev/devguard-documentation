---
title: Infrastructure as Code Security (IaC)
description: Learn how DevGuard scans Infrastructure as Code (Terraform, Kubernetes, Helm) for misconfigurations and security vulnerabilities before deployment.
seo:
  keyword_primary: "infrastructure as code security scanning"
  keywords_secondary:
    ...
    - "DevGuard IaC"
  og:
    title: "Infrastructure as Code Security (IaC) | DevGuard"
    description: "Scan Terraform, Kubernetes, and Helm configurations for misconfigurations and security issues."
    type: "article"
---
...
- [Full GitHub Workflow](/reference/github-workflows/full-scan)
- [Full GitLab Component](/reference/gitlab-components/full-scan)
