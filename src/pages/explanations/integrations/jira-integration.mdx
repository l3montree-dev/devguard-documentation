---
title: DevGuard Jira Integration
description: >-
  DevGuard Jira Integration: How DevGuard integrates with Jira — automatically
  creating issues for detected vulnerabilities, syncing remediation status, and…
seo:
  robots: 'index,follow'
  og:
    title: DevGuard Jira Integration
    description: >-
      DevGuard Jira Integration: How DevGuard integrates with Jira —
      automatically creating issues for detected vulnerabilities, syncing
