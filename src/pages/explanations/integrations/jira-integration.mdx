...
description: "How DevGuard integrates with Jira — automatically creating issues for detected vulnerabilities, syncing remediation status, and linking security findings."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: jira integration
lang: en-US
ignoreChecks: null
---
