...
description: How DevGuard integrates with Jira — automatically creating issues for detected vulnerabilities, syncing remediation status, and linking security findings to development tickets.
seo:
  keyword_primary: "DevGuard Jira integration"
  keywords_secondary:
    - "Jira vulnerability ticket"
    - "security issue tracking Jira"
    - "DevGuard Jira sync"
    - "vulnerability remediation workflow"
  og:
    title: "Jira Integration | DevGuard"
    description: "How DevGuard creates Jira issues for vulnerabilities and syncs remediation status automatically."
    type: "article"
---
