---
title: External Entity Providers
description: How DevGuard integrates with external entity providers — syncing users, groups, and repositories from GitHub, GitLab, and other identity sources.
seo:
  keyword_primary: "DevGuard external entity providers"
  keywords_secondary:
    - "GitHub GitLab user sync"
    - "identity provider integration"
    - "organization sync DevGuard"
    - "external authentication provider"
  og:
    title: "External Entity Providers | DevGuard"
    description: "How DevGuard syncs users, groups, and repositories from GitHub, GitLab, and other identity sources."
    type: "article"
---
