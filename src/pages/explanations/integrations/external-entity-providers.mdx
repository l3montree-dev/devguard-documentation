...
description: Explore the DevGuard external entity providers documentation. Explore
...
seo:
  ...
  schema:
    type: TechArticle
  keyword_primary: external entity providers
lang: en-US
ignoreChecks: null
---
...
- [GitHub Integration](/explanations/integrations/github-integration) — Details of GitHub integration
