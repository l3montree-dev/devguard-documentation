---
title: DevGuard External Entity Providers
description: >-
  How DevGuard integrates with Devguard external entity providers — syncing
  users, groups, and repositories from GitHub, GitLab, and other identity
  sources.
seo:
  robots: 'index,follow'
  og:
