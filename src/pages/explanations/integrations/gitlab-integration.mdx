...
description: How DevGuard integrates with GitLab — CI/CD components, automatic repository sync, merge request security gates, and permission management via GitLab OAuth.
seo:
  keyword_primary: "DevGuard GitLab integration"
  keywords_secondary:
    - "GitLab CI security components"
    - "GitLab DevSecOps"
    - "GitLab vulnerability scanning"
    - "GitLab SBOM pipeline"
  og:
    title: "GitLab Integration | DevGuard"
    description: "How DevGuard integrates with GitLab for CI/CD security scanning, issue creation, and permission management."
    type: "article"
---
