...
description: How DevGuard integrates with GitHub — automatic repository sync, GitHub Actions security scanning, issue creation, and permission management via GitHub App.
seo:
  ...
  og:
    title: "GitHub Integration | DevGuard"
    description: "How DevGuard integrates with GitHub for automatic scanning, issue creation, and permission management."
    type: "article"
---
