...
description: How DevGuard's integration layer works — webhooks, event-driven sync, OAuth flows, and the architecture connecting DevGuard to GitHub, GitLab, and Jira.
seo:
  keyword_primary: "DevGuard integration architecture"
  keywords_secondary:
  ...
  og:
    title: "Integration Architecture | DevGuard"
    description: "How DevGuard's integration layer connects to GitHub, GitLab, and Jira via webhooks and OAuth."
    type: "article"
---
