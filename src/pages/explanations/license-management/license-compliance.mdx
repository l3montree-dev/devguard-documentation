...
description: How DevGuard detects open source license obligations in your dependencies and helps enforce license policies to avoid legal risks from incompatible licenses.
seo:
  keyword_primary: "open source license compliance"
  keywords_secondary:
    - "license obligation detection"
    - "GPL MIT Apache license risk"
    - "SBOM license analysis"
    - "DevGuard license policy"
  og:
    title: "License Compliance | DevGuard"
    description: "Detect open source license obligations and enforce license policies to avoid legal risks."
    type: "article"
---
