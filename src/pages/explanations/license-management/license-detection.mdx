---
title: Software License Detection SBOM
description: >-
  How DevGuard performs software license detection SBOM analysis — supporting
  SPDX identifiers and CycloneDX license fields to identify dependency
  obligations.
seo:
  robots: 'index,follow'
  og:
    title: Software License Detection SBOM
    description: >-
      How DevGuard performs software license detection SBOM analysis —
      supporting SPDX identifiers and CycloneDX license fields to identify
