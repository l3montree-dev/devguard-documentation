---
title: Software License Detection via SBOM Analysis
description: "How DevGuard performs software license detection SBOM analysis — supporting SPDX identifiers and CycloneDX license fields to identify dependency obligations."
seo:
  robots: index,follow
  og:
    image: /og-image.png
  ...
  schema:
    type: TechArticle
  keyword_primary: license detection
lang: en-US
ignoreChecks: null
---
...
- [License Compliance](/explanations/license-management/license-compliance) - License types and obligations
