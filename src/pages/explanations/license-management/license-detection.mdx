...
description: How DevGuard automatically detects software licenses in dependencies using SBOM analysis, supporting SPDX identifiers and CycloneDX license fields.
seo:
  keyword_primary: "software license detection SBOM"
  keywords_secondary:
    - "SPDX license identifier"
    - "CycloneDX license field"
    - "automatic license detection"
    - "dependency license scanning"
  og:
    title: "License Detection | DevGuard"
    description: "How DevGuard automatically detects software licenses in dependencies using SBOM analysis."
    type: "article"
---
