...
description: How DevGuard performs software license detection SBOM analysis — supporting
  SPDX identifiers and CycloneDX license fields to identify dependency obligations.
seo:
  robots: index,follow
  og:
    image: /og-image.png
