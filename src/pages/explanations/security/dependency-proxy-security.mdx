---
title: Dependency Proxy Security Model
description: >-
  How the DevGuard dependency proxy security model proxy enforces security
  through malicious package blocking, cache integrity, and initialization
  protection
seo:
  robots: 'index,follow'
  og:
