---
title: Achieving SLSA Level 3 on GitLab
description: Step-by-step guide to achieving SLSA Level 3 on GitLab — creating tamper-resistant build attestations using DevGuard and GitLab CI protected runners.
seo:
  keyword_primary: "SLSA level 3 GitLab attestation"
  keywords_secondary:
    - "GitLab SLSA provenance"
    - "tamper-resistant build attestation"
    - "SLSA level 3 requirements"
    - "DevGuard SLSA GitLab"
  og:
    title: "Achieving SLSA Level 3 on GitLab | DevGuard"
    description: "Create tamper-resistant build attestations on GitLab to achieve SLSA Level 3 with DevGuard."
    type: "article"
---
...
<Callout type="warning" emoji="⚠️">
    This is an upcoming feature. We are currently working on it and will update
    the documentation soon. We would love to hear your feedback on this feature.
    Please feel free to reach out to us at [Matrix
    Chat](https://matrix.to/#/#devguard:matrix.org)
</Callout>

In the realm of software development, [the concept of attestations](/explanations/supply-chain-security/attestations) is gaining prominence. Attestations can be conceptualized as metadata that is signed and subsequently attached to a piece of software. This metadata serves various purposes, such as verifying the software's provenance.
