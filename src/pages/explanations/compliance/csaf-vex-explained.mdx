---
title: CSAF and VEX Explained
description: Understand CSAF (Common Security Advisory Framework) and VEX (Vulnerability Exploitability eXchange) — the open standards DevGuard uses for security advisories and vulnerability impact statements.
seo:
  keyword_primary: "CSAF VEX security advisory format"
  keywords_secondary:
  ...
  og:
    title: "CSAF and VEX Explained | DevGuard"
    description: "CSAF and VEX — open standards for security advisories and vulnerability exploitability statements."
    type: "article"
---
