...
**Financial Risks**: Fines up to €15 million or 2.5% of global turnover under the <Tooltip><TooltipTrigger asChild><span className="custom:underline custom:decoration-dotted custom:decoration-yellow-400 custom:decoration-1 custom:underline-offset-4 custom:cursor-pointer">CRA</span></TooltipTrigger><TooltipContent><p>EU Cyber Resilience Act - Mandatory cybersecurity requirements for products with digital elements</p></TooltipContent></Tooltip>, lost business opportunities, increased insurance premiums, audit and remediation costs.
...
**EU Cyber Resilience Act (CRA)**: Mandatory cybersecurity requirements, vulnerability handling throughout product lifecycle, <Tooltip><TooltipTrigger asChild><span className="custom:underline custom:decoration-dotted custom:decoration-yellow-400 custom:decoration-1 custom:underline-offset-4 custom:cursor-pointer">SBOM</span></TooltipTrigger><TooltipContent><p>Software Bill of Materials - Complete inventory of software components</p></TooltipContent></Tooltip> obligation, reporting of actively exploited vulnerabilities.
...
- <Tooltip>
      <TooltipTrigger asChild>
          <span className="custom:cursor-pointer custom:underline custom:decoration-yellow-400 custom:decoration-dotted custom:decoration-1 custom:underline-offset-4">
              VEX
          </span>
      </TooltipTrigger>
      <TooltipContent>
