...
description: How DevGuard enables compliance as code DevSecOps — automating security
  policy enforcement and audit evidence generation directly within your CI/CD pipeline.
seo:
  robots: index,follow
  og:
    image: /og-image.png
