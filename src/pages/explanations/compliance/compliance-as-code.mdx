...
description: Understand how DevGuard enables compliance as code — automating security policy enforcement and audit evidence generation within your CI/CD pipeline.
seo:
  ...
  keywords_secondary:
    ...
    - "audit automation"
  og:
    title: "Compliance as Code | DevGuard"
    description: "Automate security policy enforcement and audit evidence generation in your CI/CD pipeline."
    type: "article"
---
