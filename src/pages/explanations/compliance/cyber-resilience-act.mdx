...
description: Understand the EU Cyber Resilience Act (CRA) and how DevGuard helps software manufacturers meet its security requirements through automated SBOM generation and vulnerability management.
seo:
  ...
  keywords_secondary:
    ...
    - "DevGuard CRA"
  og:
    title: "EU Cyber Resilience Act | DevGuard"
    description: "How DevGuard helps meet EU Cyber Resilience Act requirements through automated SBOM and vulnerability management."
    type: "article"
---
