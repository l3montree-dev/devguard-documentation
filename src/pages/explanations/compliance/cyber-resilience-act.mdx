---
title: EU Cyber Resilience Act Compliance Guide
description: >-
  Understand the EU Cyber Resilience Act compliance requirements and how
  DevGuard helps software manufacturers meet CRA mandates with automated SBOM
  generation.
seo:
  robots: 'index,follow'
  og:
    ...
    description: >-
      Understand the EU Cyber Resilience Act compliance requirements and how
      DevGuard helps software manufacturers meet CRA mandates with automated
      SBOM generation.
    image: /og-image.png
    type: article
    schema:
