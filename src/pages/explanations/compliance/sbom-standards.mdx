...
A Software Bill of Materials (SBOM) is a comprehensive inventory of all components in software. Two SBOM standards dominate: CycloneDX and SPDX. Both serve the same purpose but differ in approach and use cases. Choosing the right SBOM standard depends on your team's primary goal — security or license compliance.
...
[^2]: Linux Foundation, _SPDX Specification_, https://spdx.dev/use/specifications/
