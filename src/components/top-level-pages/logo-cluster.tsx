    ...
    return (
        <motion.div
            ...
            className={clsx(
                ...
                'bg-[radial-gradient(circle,transparent_25%,color-mix(in_srgb,var(--color-white)_var(--opacity),transparent)_100%)]',
...
function Circles() {
    return (
        <div className="absolute inset-0">
            ...
            <div className="bg-linear-to-t absolute inset-0 from-white to-35%" />
        </div>
    )
}
...
function Logo({
    ...
    return (
        <motion.img
            ...
            className="absolute size-16 rounded-full bg-white/10 shadow-sm ring-1 ring-black/5"
        />
    )
}
    ...
    return (
        <div aria-hidden="true" className="relative h-full overflow-hidden">
            ...
            <div className="absolute left-1/2 h-full w-[26rem] -translate-x-1/2">
                <MainLogo />
                <Logo
                    src="/logo-cluster/travis.svg"
                    left={360}
                    top={144}
                    hover={{ x: 6, y: 1, rotate: 5, delay: 0.38 }}
                />
                <Logo
                    src="/logo-cluster/jenkins.svg"
                    left={285}
                    top={20}
                    hover={{ x: 4, y: -5, rotate: 6, delay: 0.3 }}
                />
                <Logo
                    src="/logo-cluster/cli.svg"
                    left={255}
                    top={210}
