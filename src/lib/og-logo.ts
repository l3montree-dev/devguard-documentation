// Inlined so the OG image edge function never needs to fetch this over the
// network. Self-hosted edge API routes can't reliably resolve their own
// public origin (see src/pages/api/og-image.tsx), and even a correct origin
// can fail to hairpin back through the ingress from inside the container.
export const OG_LOGO_SVG = `<?xml version="1.0" encoding="utf-8"?>
